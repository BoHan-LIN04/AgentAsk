...
if __name__ == '__main__':
    ...
    clarify_enabled = (args.clarify == 'llm')
    router.clarify_manager = ClarifyManager(enabled=clarify_enabled, model=args.clarify_model, output_path=args.clarify_output, task='math', prompt_dir='MAR/ClarifyPrompts')
